...
import { Feather, Octicons, Ionicons, Entypo, MaterialCommunityIcons, FontAwesome5 } from '@expo/vector-icons';
            ...
            <LinearGradient colors={['#7E7FD5', '#E9E4F0']} style={{ flex: 1 }}>
                <View style={{ padding: 12 }}>
                    <View style={{ flexDirection: 'row', alignItems: "center", justifyContent: 'space-between' }}>
                        ...
                        <Text style={{ fontSize: 16, fontWeight: '600' }}>Student Attendance System</Text>
                        <Entypo name="lock" size={24} color="black" />
                    </View>

                    <View style={{ marginTop: 20, flexDirection: 'row', alignItems: 'center', gap: 20 }}>
                        <Pressable onPress={() => router.push("/(home)/students")} style={{ backgroundColor: "#D3CCE3", padding: 12, alignItems: 'center', borderRadius: 6, justifyContent: 'center', flex: 1 }}>
                            <View style={{ width: 50, height: 50, backgroundColor: 'white', borderRadius: 25, alignItems: 'center', justifyContent: 'center' }}>
                                <Ionicons name="people-sharp" size={24} color="black" />
                            </View>
                            <Text style={{ marginTop: 7, fontWeight: '600' }}>Students List</Text>
                        </Pressable>
                        <Pressable style={{ backgroundColor: "#D3CCE3", padding: 12, alignItems: 'center', borderRadius: 6, justifyContent: 'center', flex: 1 }}>
                            <View style={{ width: 50, height: 50, backgroundColor: 'white', borderRadius: 25, alignItems: 'center', justifyContent: 'center' }}>
                                <Ionicons name="people-sharp" size={24} color="black" />
                            </View>
                    ...
                    <View style={{ marginTop: 20, paddingHorizontal: 10, paddingVertical: 10, backgroundColor: 'white' }}>
                        ...
                        <Pressable style={{ backgroundColor: "#BE93C5", borderRadius: 6, padding: 10, flexDirection: 'row', alignItems: 'center', marginVertical: 10 }}>
                            ...
                            <Text style={{ marginLeft: 10, fontSize: 16, fontWeight: "600", flex: 1 }}>Summery Report</Text>
                            <View style={{ width: 35, height: 35, borderRadius: 7, backgroundColor: 'white', alignItems: 'center', justifyContent: 'center' }}>
                                <Entypo name="chevron-right" size={24} color="black" />
                            </View>
                        </Pressable>
                    ...
                    <View style={{ marginTop: 20, flexDirection: 'row', alignItems: 'center', gap: 12 }}>
                        <View style={{ backgroundColor: "#d3cce3", borderRadius: 6, padding: 12, alignItems: 'center', justifyContent: 'center', flex: 1 }}>
                            ...
                            <Text style={{ marginTop: 7 }}>Mark Sheets</Text>
                        </View>
